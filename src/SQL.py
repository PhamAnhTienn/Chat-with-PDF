...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [
        AIMessage(content="Hello! I am a chatbot that can help you with SQL query. How can I help you today?")
    ]

def show_SQL_page():
    st.set_page_config(page_title="Chat with MySQL", page_icon=":speech_balloon:")
    
    st.header("Chat with MySQL :books:")
    ...
    with st.sidebar:
        ...
        st.text_input("Password", type="password", value="13082005", key="Password")
    ...
    user_query = st.chat_input("Type your message here", key="Message")
